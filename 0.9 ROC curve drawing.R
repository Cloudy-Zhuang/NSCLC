...
openxlsx::write.xlsx(roc.res,"重要基因roc结果.xlsx")

roc.res %>% 
  DT::datatable()

# draw ----------------------------------------------------------------------
setwd("C:/Users/Cloudy/Desktop/论文写作/文章写作预分析/figure")

dir.create("roc_curve")
setwd("C:/Users/Cloudy/Desktop/论文写作/文章写作预分析/figure/roc_curve")
