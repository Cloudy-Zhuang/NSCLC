...
#save(index_clean,file="dat_output/Calculation result of TCGA cohort path index.Rdata")
...
# The effects of pathway index on survival --------------------------------------------------------------
...
save(index.os,file = "dat_output/cox analysis results of TCGA-NSCLC index.Rdata")
